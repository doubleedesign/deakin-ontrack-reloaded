...
import { faS, faLightbulb, faListUl, faUserGear, faArrowUpRightFromSquare } from '@fortawesome/pro-solid-svg-icons';
...
library.add(fal, faS, faLightbulb, faLightbulbOn, faListUl, faXmark, faUserGear, faArrowUpRightFromSquare);
